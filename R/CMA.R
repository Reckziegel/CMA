...
#' fully flexible copulas. With CMA, it's possible to decompose a multivariate dataset
#' between the copulas and the marginals from any arbitrary distribution.
