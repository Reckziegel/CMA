...
Once the the "separation" is done it's necessary to choose a target distribution for the data. For simplicity, let's fit a Student-t, but it could be *any* distribution (see "Marginal Distributions" on the [reference page](https://reckziegel.github.io/CMA/reference/index.html)).
