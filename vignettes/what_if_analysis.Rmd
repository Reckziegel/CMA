...
4.  Merge the newly generated scenarios with the empirical copulas.
...
Once the the "separation" is done it's necessary to choose a target distribution for the data. For simplicity, let's fit a Student-t, but it could be *any* distribution (see "Marginal Distributions" 
...
Indeed, differentiating skill from luck is notoriously difficult. 
